...
for i = 1:length(val_categories)-1
    ...
    %kk.poly(hazard.assets.lon(indx)+res_deg*sind(tp), hazard.assets.lat(indx)+res_deg*cosd(tp), ...
...
% 
%     kk.poly(hazard.assets.lon(i)+0.05*sind(tp), hazard.assets.lat(i)+0.05*cosd(tp), ...
%         'altitude', 100,... %hazard.assets.Value(i)/max_value*100
%         'altitudeMode','clampToGround', ...
%         'description','test',...
%         'lineWidth',0,...
...
%         indx = val_log10>= val_categories(i) && val_log10< val_categories(i+1); 
% 
%         kk.poly(hazard.assets.lon(indx)+0.05*sind(tp), hazard.assets.lat(indx)+0.05*cosd(tp), ...
%             'altitude', 100,... %hazard.assets.Value(i)/max_value*100
%             'altitudeMode','clampToGround', ...
%             'description','asset',...
%             'lineWidth',0,...
...
% %         color_indx = color_indx(1);
% % 
% %         kkk.poly(hazard.assets.lon(i)+0.05*sind(tp), hazard.assets.lat(i)+0.05*cosd(tp), ...
