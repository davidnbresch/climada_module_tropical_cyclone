function hazard = climada_hazard_distance_to_coast_china(hazard, centroids, tc_track, check_figure)
...
if check_figure
    ...
    title('China: Weakening of wind intensity versus distance to coast')
