function hazard  = climada_tr_hazard_set_fast(tc_track,hazard_set_file,centroids)
% generate hazard rain set from tc_tracks
% NAME:
%   climada_tr_hazard_set_fast
% PURPOSE:
...
% CALLING SEQUENCE:
%   hazard = climada_tr_hazard_set_fast(tc_track,hazard_set_file)
% EXAMPLE:
%   tc_track=climada_tc_track_load('TEST_tracks.atl_hist');
%   centroids=climada_centroids_load('USFL_MiamiDadeBrowardPalmBeach');
%   hazard=climada_tr_hazard_set_fast(tc_track,'_TR_TEST_PARFOR',centroids);
% INPUTS:
...
% David N. Bresch, david.bresch@gmail.com, 20160528, parfor, much faster (factor 2-5)
%-
